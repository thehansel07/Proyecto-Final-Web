        ...
        <Modal key={`modal-${props.id}`}  show={show} onHide={hideModal} animation={false}>
            ...
            <Modal.Body>
                <Form onSubmit={editChair}>
                    ...
                    <Form.Row>
                        <Form.Label column sm="3">Diseños: </Form.Label>
            ...
            <Modal.Footer>        
                <Button className="mr-auto" variant="danger" onClick={delChair}>Eliminar</Button>
                <Button variant="outline-secondary" onClick={hideModal}></Button>
            </Modal.Footer>
        </Modal>    
        </>
    )
