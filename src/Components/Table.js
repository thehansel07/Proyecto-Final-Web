    ...
    return(
        ...
        <div key="k" className="col-xs-12 col-sm-6 col-md-6 col-lg-4 col-xl-3 mb-2">
            <div className="card shadow-sm">
                ...
                <div className="card-body">
                    ...
                    <small><strong>Produccion: </strong><span className="text-muted">{props.producer}</span></small>
                </div>
        ...
        <Modal key={props.id} show={show} onHide={hideModal} animation={false}>
            <Modal.Header closeButton>
                <Modal.Title>Editar Produccion</Modal.Title>  
            </Modal.Header>
            <Modal.Body>
                <Form onSubmit={editTable}>
                    ...
                    <Form.Row>
                        ...
                        <Col>
                            <Form.Control onChange={handleChange} as="select" name="category" className="mb-2">
                                ...
                                <option>Mesa de café</option>
                                <option>Mesa auxiliar</option>
                            </Form.Control>
                        </Col>
                    </Form.Row>
                    <Form.Row>
                    ...
                    <Form.Row>
                        <Form.Label column sm="3">Años: </Form.Label>
            ...
            <Modal.Footer>        
                <Button className="mr-auto" variant="danger" onClick={delTable}>Eliminar</Button>
